package GetCustomerDetailsForDeletionServlet.java;
...
@WebServlet("/GetCustomerDetailsForDeletion")
public class GetCustomerDetailsForDeletionServlet extends HttpServlet {
        ...
        try (Connection connection = DatabaseConnection.initializeDatabase()) {
            ...
            try (PreparedStatement preparedStatement = connection.prepareStatement(query)) {
                ...
                if (rs.next()) {
                    ...
                    request.getRequestDispatcher("confirmDeleteCustomer.jsp").forward(request, response);
                } else {
